...
// ─────────────────────────────────────────────────────────────────────
// 1. CREATE src/components/dashboard/InvestmentEstimator.jsx
// ─────────────────────────────────────────────────────────────────────

const estimator = `import React, { useState, useMemo } from 'react';
...
fs.writeFileSync('src/components/dashboard/InvestmentEstimator.jsx', estimator, 'utf8');
console.log('✅ InvestmentEstimator.jsx created');

// ─────────────────────────────────────────────────────────────────────
// 2. INJECT into Dashboard.jsx
// Add the import and drop the widget into the right sidebar
// ─────────────────────────────────────────────────────────────────────

let dash = fs.readFileSync('src/pages/Dashboard.jsx', 'utf8');

// Add import after the last dashboard component import
dash = dash.replace(
...
// Insert the widget into the right sidebar column, after SavingsGoalCard
dash = dash.replace(
...
fs.writeFileSync('src/pages/Dashboard.jsx', dash, 'utf8');
console.log('✅ Dashboard.jsx updated (InvestmentEstimator injected)');
