...
// ─────────────────────────────────────────────────────────────────────
// 1. CREATE src/pages/Goals.jsx
// ─────────────────────────────────────────────────────────────────────

const goalsPage = `import React, { useState, useEffect } from 'react';
...
fs.writeFileSync('src/pages/Goals.jsx', goalsPage, 'utf8');
console.log('✅ Goals.jsx created');

// ─────────────────────────────────────────────────────────────────────
// 2. UPDATE App.jsx — add Goals route
// ─────────────────────────────────────────────────────────────────────
...
console.log('✅ App.jsx updated (Goals route added)');

// ─────────────────────────────────────────────────────────────────────
// 3. UPDATE Sidebar.jsx — add Goals to nav
// ─────────────────────────────────────────────────────────────────────
...
console.log('✅ Sidebar.jsx updated (Goals nav item added)');

// ─────────────────────────────────────────────────────────────────────
// 4. UPDATE MobileNav.jsx — add Goals to bottom nav
// ─────────────────────────────────────────────────────────────────────
...
console.log('✅ MobileNav.jsx updated (Goals tab added)');
