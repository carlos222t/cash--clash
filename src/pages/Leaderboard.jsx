      ...
      <div className="cc-lb-root" style={{ maxWidth: 720, margin: '0 auto', padding: '24px 20px 80px' }}>
        ...
        <Tabs defaultValue="xp">
          <TabsList style={{ width: '100%', display: 'flex' }}>
            <TabsTrigger value="xp"          style={{ flex: 1, display: 'flex', alignItems: 'center', gap: 5 }}><Star   style={{ width: 13, height: 13 }} /> Most XP</TabsTrigger>
            <TabsTrigger value="battles"     style={{ flex: 1, display: 'flex', alignItems: 'center', gap: 5 }}><Swords style={{ width: 13, height: 13 }} /> Battles Won</TabsTrigger>
            <TabsTrigger value="tournaments" style={{ flex: 1, display: 'flex', alignItems: 'center', gap: 5 }}><Trophy style={{ width: 13, height: 13 }} /> Tournaments</TabsTrigger>
            <TabsTrigger value="clans"       style={{ flex: 1, display: 'flex', alignItems: 'center', gap: 5 }}><Shield style={{ width: 13, height: 13 }} /> Clans</TabsTrigger>
          </TabsList>
