    ...
    <div style={{
      ...
      <style>{`
        ...
        @media (max-width: 640px) {
          .customize-grid { display: flex !important; flex-direction: column !important; }
          .customize-preview { position: static !important; order: -1; }
          .customize-forms { order: 1; }
        }
      `}</style>
      ...
      <div style={{ maxWidth: 900, margin: '0 auto' }}>
        ...
        {/* ── Two-column layout ── */}
        <div className="customize-grid" style={{ display: 'grid', gridTemplateColumns: 'minmax(0,1.4fr) minmax(0,1fr)', gap: 20, alignItems: 'start' }}>

          {/* LEFT: forms */}
          <div className="customize-forms" style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <div className="customize-preview" style={{ position: 'sticky', top: 24 }}>
